...
const SkillBar = ({ skill, level }) => (
  <div className="mb-6">
    <div className="text-lg font-medium text-right">{skill}</div>
  ...
  return (
    <div className="container mx-auto py-6 h-full">
      <div className="flex flex-col lg:flex-row justify-around items-center h-full">
        {/* Bio Section */}
        <div className="lg:w-1/4 px-4 flex flex-col justify-center text-right mx-auto">
          ...
          <ul className="list-none mt-4">
            <li className="mb-2"><FaEnvelope className="mr-2" /> email@example.com</li>
            <li className="mb-2"><FaPhone className="mr-2" /> +123456789</li>
            <li className="mb-2"><FaLinkedin className="mr-2" /> LinkedInProfile</li>
            <li className="mb-2"><FaGithub className="mr-2" /> GitHubProfile</li>
          </ul>
        </div>
        ...
        {/* Skills Section */}
        <div className="skills-section lg:w-1/4 px-4 flex flex-col justify-center text-right mx-auto">
